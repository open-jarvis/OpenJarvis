...
const enUS = {
  ...
  'settings.apiKeyRemoveFailed': 'Failed to remove API key',
  'settings.apiKeySaveFailed': 'Failed to save API key',
  'settings.apiKeySavedByServer': 'Saved by local server',
  'settings.apiKeySavedSecurely': 'Saved in secure storage',
...
const zhCN: Record<keyof typeof enUS, string> = {
  ...
  'settings.apiKeyRemoveFailed': '移除 API 密钥失败',
  'settings.apiKeySaveFailed': '保存 API 密钥失败',
  'settings.apiKeySavedByServer': '已由本地服务器保存',
  'settings.apiKeySavedSecurely': '已保存到安全存储',
