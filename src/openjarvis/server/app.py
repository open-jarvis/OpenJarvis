...
def create_app(
    ...
    *,
    ...
    if api_key or workos_client_id:
        ...
        workos_jwks_client = (
            _build_jwks_client(workos_client_id) if workos_client_id else None
        )
        app.state.workos_client_id = workos_client_id
        app.state.workos_jwks_client = workos_jwks_client
        app.add_middleware(
            AuthMiddleware,
            api_key=api_key,
            workos_client_id=workos_client_id,
            workos_jwks_client=workos_jwks_client,
        )
        if workos_client_id and workos_jwks_client is not None:
            logger.info(
